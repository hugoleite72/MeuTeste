...
public class VoltarSemParametro extends AppCompatActivity {
    Intent intent;
    String vtipo;
    Button btvoltar;
        ...
        btvoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    intent.putExtra("returnedData", "Teste Hugo Heroi Com Sucesso!");
                    finish();
               }
            }
        });
    ...
    class DownloadJsonAsyncTask extends AsyncTask<String, Void, List<Pessoa>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = ProgressDialog.show(VoltarSemParametro.this, "Aguarde",
    ...
    public void mensagem(String titulo, String mensagem) {
        android.app.AlertDialog.Builder alertateste = new android.app.AlertDialog.Builder(VoltarSemParametro.this);
